            ...
            userRoles.includes("Candidat") ? (
              ...
              <>
                <ul className="navbar__nav">
                  ...
                  <li><Link href="/Admin/Create-profile" className="navbar__nav-item text-sm">Create Company Profile</Link></li> 
                  <li><Link href="#" className="navbar__nav-item text-sm">User Management</Link></li> 
                  ...
                  <li><Link href="#" className="navbar__nav-item text-sm">Account Settings</Link></li> 
                  <li>
